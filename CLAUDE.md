...
- **Pasos 1–17 completados.** Paso **18 pendiente** (mover `internal/agent/` → `pkg/agent/`, sección "Embedding as a library" en README, repaso final de `Taskfile.yml` + configs).
